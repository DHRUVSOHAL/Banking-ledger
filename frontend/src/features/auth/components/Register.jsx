...
export default function Register() {
    const headingText = "You can Register for an account here";
                ...
                <div className="animate-fade-in transition-all duration-500"> 
                    <form className='flex flex-col gap-4'>
                        <div className="flex flex-col gap-1">
                            {/* 3. Balanced label sizes and added proper padding/height to inputs */}
                            <label className='text-zinc-800 font-medium text-sm'>Username</label>
                            <input type="text" className="border border-zinc-300 rounded-md p-2 w-full h-10 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                        </div>
